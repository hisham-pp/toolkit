...
import { PROJECT_COLORS } from "@/utility/constants/project-colors";
...
export default function AdvancedTodos() {
  ...
  const [todoPriority, setTodoPriority] = useState<ProjectTodo["priority"]>(TodoPriority.Medium);
  ...
  const addTodo = () => {
    ...
    setTodoTitle("");
    setTodoNotes("");
    setTodoPriority(TodoPriority.Medium);
    setTodoDueDate("");
    setTodoError("");
  };
                      ...
                      <div className="flex flex-wrap gap-2">
                        <span
                          className={cn(
                            ...
                            todo.priority === TodoPriority.High && "border-red-500/30 text-red-300 bg-red-500/10",
                            todo.priority === TodoPriority.Medium && "border-amber-500/30 text-amber-300 bg-amber-500/10",
                            todo.priority === TodoPriority.Low && "border-sky-500/30 text-sky-300 bg-sky-500/10"
                          )}
                        >
                          {todo.priority}
                        </span>
